...
if ($mode=="search"){
    ...
    $sql= "select * from buy_goods order by regist_day desc";
}
    		...
    		<div id="review_kind">    	
        		...
        		<table id="buy_list_table">
        			...
        			<tr>
        				...
        				<td class="prod_image"><a href="../../shopping_buy/source/view.php?num=<?=$num?>"><img class="prod_image2" src="../../input/upload_image/<?=$image?>"></a></td>
        				<td class="prod_info"><a href="../../shopping_buy/source/view.php?num=<?=$num?>"><b><?=$name2?></b><br>[옵션 : 
        				<?php 
        				if($type == 'clothe')
        				{
        				?>(<?=$size?>)/
        				...
        				?>
        				<td class="prod_baesong">배송완료<br></td>
        				<?php 
    					}
        				?>	
                	...
                	<tr>
                    	...
                    	<?PHP 
                          ...
                          if( $start_page > $pages_scale ){
                              ...
                              echo( "<a href='./order_list.php?page=$go_page'> << </a>" );
                          }else{
                              echo( " << " );
                          }
                        ?>
                    	...
                    	<?PHP 
                          #----------------이전페이지 존재시 링크------------------#
                          if( $pre_page ){
                              echo( "<a href='./order_list.php?page=$pre_page'> < </a>" );
                          }else{
                              echo( " < " );
                          }
                        ?>
                        ...
                        for( $dest_page = $start_page; $dest_page <= $end_page; $dest_page++ )
                          if ( $dest_page == $page ){
                              ...
                              echo "<td width='30'>";
                              echo( "<a href='./order_list.php?page=$dest_page'>$dest_page</a>" );
                              echo "</td>";
                          }
                          ?>
                    		<td width="30">
                    	<?PHP 
                          #----------------이전페이지 존재시 링크------------------#
                          if( $next_page ){
                              echo( "<a href='./order_list.php?page=$next_page'> > </a>" );
                          }else{
                              echo( " > " );
                          }
                        ?>
