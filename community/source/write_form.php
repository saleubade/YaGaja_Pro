...
<html>
 ...
 <div class="write_form"></div>
  ...
  <div class="write_1_2"><textarea name="content" rows="5" cols="79"><?=$item_content?></textarea></div>
  </div>
...
<a href="list.php?table=<?=$table?>&page=<?=$page?>&continent=<?=$continent ?>"><img src="../img/list.png"></a>
</div>
